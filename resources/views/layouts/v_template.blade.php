...
<head>
    ...
    <meta charset="utf-8" />
    <title>SODA Enterprises Inc.</title>
	...
	<link rel="shortcut icon" href="{{asset('metch')}}/media/favicon.ico" />
    {{-- cdn --}}
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" class="text-dark-75 text-hover-primary">SODA Enterprises Inc.</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
